...
import { ContextualTooltip, QuickHelp } from "@/components/SimpleTooltip";
            ...
            >
              ...
              <Link to="/register?role=exporter">
                <Button
                  size="lg"
                  variant="outline"
                  className="px-8 py-4 text-lg group border-2 border-primary text-primary bg-white dark:bg-background hover:bg-primary hover:text-primary-foreground transition-all shadow-lg hover:shadow-xl font-semibold"

      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Track your orders and manage escrow payments securely
          </p>
        </div>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center space-x-4 mb-2">
                          ...
                          <Badge
                            className={`trust-badge ${getStatusColor(order.status)}`}
                          >
                            {order.status}
                          </Badge>
                        </div>
                        ...
                        <div className="bg-muted p-4 mb-4">
                          <h4 className="font-medium text-foreground mb-3">
                            Escrow Payment Progress
                          </h4>
                          <div className="grid grid-cols-3 gap-4 text-sm">
                            <div
                              className={`text-center ${getPaymentStepStatus(order.paymentSteps.advance)}`}
                            >
                              <div className="flex items-center justify-center mb-1">
                                {order.paymentSteps.advance.status ===
                                "completed" ? (
                              ...
                              <p className="text-xs">
                                {order.paymentSteps.advance.amount}
                              </p>
                            ...
                            <div
                              className={`text-center ${getPaymentStepStatus(order.paymentSteps.inspection)}`}
                            >
                              <div className="flex items-center justify-center mb-1">
                                {order.paymentSteps.inspection.status ===
                                "completed" ? (
                                  <CheckCircle className="h-4 w-4 text-success" />
                                ) : (
                                  <Clock className="h-4 w-4" />
                              ...
                              <p className="text-xs">
                                {order.paymentSteps.inspection.amount}
                              </p>
                            ...
                            <div
                              className={`text-center ${getPaymentStepStatus(order.paymentSteps.delivery)}`}
                            >
                              <div className="flex items-center justify-center mb-1">
                                {order.paymentSteps.delivery.status ===
                                "completed" ? (
                                  <CheckCircle className="h-4 w-4 text-success" />
                                ) : (
                                  <Clock className="h-4 w-4" />
                              ...
                              <p className="text-xs">
                                {order.paymentSteps.delivery.amount}
                              </p>
            ...
            <div className="space-y-6">
              <Card className="card-corporate">
                <CardHeader>
                  ...
                  <p className="text-muted-foreground">
                    Our 3-step escrow system protects both buyers and sellers
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center p-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        10% advance payment secures the order and initiates
                        production/dispatch
                      </p>
                    </div>
                    <div className="text-center p-4">
                      ...
                      <h3 className="font-medium text-foreground mb-2">
                        Step 2: Inspection Payment
                      </h3>
                      <p className="text-sm text-muted-foreground">
                        50% payment after quality inspection and shipment
                        confirmation
                      </p>
                    </div>
                    <div className="text-center p-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Remaining balance paid upon confirmed delivery and
                        acceptance
                      </p>
                    </div>
                  </div>

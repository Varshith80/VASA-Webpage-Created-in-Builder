  ...
  const conversations: Conversation[] = [
    {
      ...
      lastMessage: {
        ...
        content:
          "I can provide the premium cotton samples by tomorrow. The MOQ is 1000kg as discussed.",
    ...
    },
    {
      ...
      lastMessage: {
        ...
        content:
          "Could you please share the quality certificates for the cardamom shipment?",
    ...
    },
    {
      ...
      lastMessage: {
        ...
        receiverId: "current-user",
        content:
          "The silk shipment has been dispatched. Tracking number: TRK123456789",
  ...
  const messages: Message[] = [
    {
      ...
      content:
        "Hi, I'm interested in your premium cotton. Could you share more details about quality and pricing?",
    ...
    },
    {
      ...
      receiverId: "current-user",
      content:
        "Hello! Thank you for your interest. We have premium Grade A cotton available. The current price is $2.50 per kg with MOQ of 1000kg.",
    ...
    },
    {
      ...
      receiverId: "current-user",
      content:
        "I'm attaching our quality certificates and sample specifications for your review.",
    ...
    },
    {
      ...
      receiverId: "trader-001",
      content:
        "Great! The quality looks good. Can you provide samples for physical inspection? Also, what are your payment terms?",
    ...
    },
    {
      ...
      receiverId: "current-user",
      content:
        "I can provide the premium cotton samples by tomorrow. The MOQ is 1000kg as discussed. Payment terms: 10% advance, 50% on inspection, balance on delivery.",
      timestamp: "2024-01-15T14:30:00Z",
      messageType: "text",
      status: "read",
      attachments: [
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm opacity-90">
                  - Never share personal financial details outside platform
                  payments - Report suspicious behavior immediately - All
                  conversations are monitored for compliance
                </span>
              </div>
              <Button
                variant="ghost"
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                          ...
                          <span>
                            Response: {selectedConv.participant.responseTime}
                          </span>

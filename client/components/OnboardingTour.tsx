...
const importerSteps: TourStep[] = [
  {
    ...
    description:
      "Let's take a quick tour to help you get started with importing products from verified exporters worldwide.",
    target: "body",
    position: "bottom",
  ...
  },
  {
    ...
    title: "Find Products",
    description:
      "Use our global search to find products from verified exporters. Filter by category, country, price, and certifications.",
  ...
  },
  {
    ...
    description:
      "View detailed product specifications, seller information, certifications, and pricing. Check trust badges for verified sellers.",
  ...
  },
  {
    ...
    description:
      "Our 3-step payment system protects your purchase: 10% advance, 50% on shipment, 40% on delivery.",
  ...
  },
  {
    ...
    description:
      "Monitor your orders in real-time from placement to delivery. Get notifications at every milestone.",
  ...
  },
  {
    ...
    title: "Communication",
    description:
      "Communicate directly with exporters, share documents, and resolve queries through our secure messaging system.",
  ...
  },
  {
    ...
    description:
      "Access your personalized dashboard for order management, analytics, and account settings.",
...
const exporterSteps: TourStep[] = [
  {
    ...
    title: "Welcome to VASA!",
    description:
      "Let's show you how to start selling your products to importers worldwide through our secure platform.",
    target: "body",
    position: "bottom",
    icon: <Star className="h-5 w-5" />,
  },
  {
    ...
    description:
      "Complete your KYC verification and trade license validation to build trust with potential buyers.",
  ...
  },
  {
    ...
    description:
      "Add your products with detailed specifications, competitive pricing, and quality certifications.",
  ...
  },
  {
    ...
    description:
      "Use high-quality images, detailed descriptions, and competitive pricing to attract more buyers.",
  ...
  },
  {
    ...
    title: "Manage Orders",
    description:
      "Process incoming orders, update shipping information, and track payments through your order dashboard.",
    target: '[data-tour="orders"]',
    position: "bottom",
    icon: <Truck className="h-5 w-5" />,
  },
  {
    ...
    description:
      "Monitor your sales performance, customer feedback, and optimize your listings for better visibility.",
  ...
  },
  {
    ...
    description:
      "Configure your payment preferences, notification settings, and business information.",
  ...
  const importerTasks = [
    {
      ...
      completed: user.hasCompletedProfile,
    },
    { id: "verify", label: "Verify Account", completed: user.isVerified },
    {
      id: "documents",
      label: "Upload Documents",
      completed: user.hasUploadedDocuments,
    },

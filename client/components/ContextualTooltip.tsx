...
export const TooltipContentTemplates = {
  ...
  shippingTerms: (
    <div className="space-y-2">
      ...
      <div className="text-sm space-y-1">
        <div><strong>FOB:</strong> Free on Board</div>
        <div><strong>CIF:</strong> Cost, Insurance, Freight</div>
        <div><strong>DDP:</strong> Delivered Duty Paid</div>
        <div><strong>EXW:</strong> Ex Works</div>
      </div>
      <div className="text-xs text-muted-foreground mt-2">
  ...
  complianceCheck: (
    <div className="space-y-2">
      ...
      <div className="text-sm">
        We automatically check trade regulations, restricted items, and documentation 
  ...
  currencyConversion: (
    <div className="space-y-2">
      ...
      <div className="text-sm">
        Prices are converted using real-time exchange rates. Final amount may vary 
        slightly based on your bank's conversion rates.
      </div>
    </div>
  ),
};
